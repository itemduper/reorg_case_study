...
class DatasetSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Datasets newer than 2015 have changes to the produuct indicators that are incompatible with the existing payments table.  Potentially will implement this in the future.
